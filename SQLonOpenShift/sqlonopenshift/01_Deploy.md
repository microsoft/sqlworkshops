...
<dl>
  ...
  <dt><a href="#3-0">1.0 SQL Server Deployment</a></dt>
  
</dl>

<p style="border-bottom: 1px solid lightgrey;"></p>

<h2><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/pencil2.png"><a name="3-0">1.0 SQL Server Deployment</a></h2>
...
Follow the instructions for [SQL Server Deploy on OpenShift](Module%201%20Activity%20-%20Deploy%20SQL%20Server%20on%20OpenShift)
