...
Use the File menu to open up the **adr.ipynb** notebook and go through all the steps. There is additional documentation on how to use SQL notebooks at https://docs.microsoft.com/en-us/sql/azure-data-studio/sql-notebooks. 
