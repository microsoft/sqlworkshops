...
In this workshop you'll cover using a Process and various Platform components to create and enhance your new or existing SQL Server solutions on premises, in the cloud, or in a hybrid architecture. In each module you'll get more references, which you should follow up on to learn more. Also watch for links within the text - click on each one to explore that topic. There's a lot here - so focus on understanding the overall system first, then come back and explore each section.
...
<dl>
  ...
  <dt><a href="#1-1">1.1 Business Applications</a></dt>
  <dt><a href="#1-2">1.2 Workshop Scenario</a></dt>
  <dt><a href="#1-3">1.3 SQL Server End of Support</a></dt>
  <dt><a href="#1-4">1.4 SQL Server 2016 and 2017 Innovations</a></dt>
  <dt><a href="#1-5">1.5 Overview: SQL Server 2019</a></dt>
...
<h2><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/pencil2.png"><a name="1-1">1.1 Business Applications</a></h2>

Businesses require near real-time insights from ever-larger sets of data. This data requires storage and processing in ways that allow fast response times. In addition to simply querying this data or creating high-performing, secure applications, organizations want full analysis and likely even predictive capabilities over their data. A few industry examples of applications of technology that create large data sets for analytics are:
...
<p><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png">Spend 5 minutes looking online for the terms "Data" and "Analytics" and "Top" for your industry. For example:  <b>Manufacturing Data Analytics Top</b></p>
...
Recently, WWI added web and mobile commerce to their platform. In doing so, they do not want to simply make their inventory available online. They want to build upon their track record of strong customer connections, and engage with their customers through personalized, high-quality applications and experiences that incorporate data and intelligence. 

Prior to expanding to their current omni-channel strategy, WWI had a simple Point of Sale (POS) application that handled customer orders at each retail store. The back-end was a series of service layers used to process orders and store them in a SQL database on SQL Server 2008 R2. They had designed their systems and tuned them to handle this level of data.

<img style="height: 150; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);" src="../graphics/WWI-002.png">

The technology team at WWI has recognized that moving to an omni-channel strategy is not only generating significant amounts of additional data and data formats (and consumer demand), but also taking a toll on querying response times. They anticipate needing to implement the following to reach more customers and grow the business:
 ...
 - Apply analytics and querying with high-performance responses
 - A platform to develop data-based applications in a secure fashion, at scale
 - Enable AI in apps to actively engage with customers

Over the course of the workshop, you'll learn how the team solves each of these challenges.

<br>
<p style="border-bottom: 1px solid lightgrey;"></p>
<br>

<p><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/point1.png"><b>Activity: TODO</b></p>

TODO

<p><img style="margin: 0px 15px 15px 0px;" src="../graphics/checkmark.png"><b>Description</b></p>

Using the following steps, you will create a Resource Group in Azure that will hold your BDC on AKS. When you complete your lab you can delete this Resource Group which will stop the Azure charges for this course. TODO

<p><img style="margin: 0px 15px 15px 0px;" src="../graphics/checkmark.png"><b>Steps</b></p>

<p><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png"> <a href="00-Pre-Requisites.md" target="_blank">Ensure that you have completed all Pre-Requisites</a>.</p>
<p><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png"> <a href="https://docs.microsoft.com/en-us/sql/big-data-cluster/quickstart-big-data-cluster-deploy?view=sqlallproducts-allversions" target="_blank">TODO</a>. TODO</b>.</p>
 
<p style="border-bottom: 1px solid lightgrey;"></p>

<h2><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/pencil2.png"><a name="1-3">1.3 SQL Server End of Support</a></h2>

In this section you will learn more about what is planned for SQL Server end of life support in the upcoming months/years.

<img style="height: 150; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);" src="../slides/slides-images/Slide4.jpg">

As shown in the image above, various SQL Server editions are reaching their end of support from Microsoft. You can look up specific products that may be relevant to you or your organization [here](https://support.microsoft.com/en-us/lifecycle/search?alpha=microsoft%20sql%20server).

<h3>What does end of support mean?</h3>

An unsupported version of SQL Server will no longer receive software updates or patches. These updates include security updates that can help protect your data from harmful viruses, spyware, and other malicious software which can steal your personal information. Being supported basically means that Microsoft is working to "support" the version you're operating on.


<h3>What are my options?</h3>

You can continue operations if you are running an unsupported version of SQL Server, it won't spontaneously shutdown or cease existence. However, Microsoft **strongly recommends you don't**. By continuing to operate, you are actively choosing to not protect your data. You should highly consider moving to a supported version before support for your instance expires.
...
<h2><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/pencil2.png"><a name="1-4">1.4 SQL Server 2016 and 2017 Innovations</a></h2>
...
<h2><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/pencil2.png"><a name="1-5">1.5 Overview: SQL Server 2019</a></h2>
